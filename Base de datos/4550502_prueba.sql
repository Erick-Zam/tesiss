...
-- Tiempo de generación: 22-02-2025 a las 23:01:15
...
ALTER TABLE `productos`
  ADD PRIMARY KEY (`id`),
  ADD KEY `geolocalizacion_id` (`geolocalizacion_id`),
  ADD KEY `proveedor_id` (`proveedor_id`);
...
--
ALTER TABLE `detalle_envio`
  ADD CONSTRAINT `detalle_envio_ibfk_1` FOREIGN KEY (`producto_id`) REFERENCES `productos` (`id`),
  ADD CONSTRAINT `detalle_envio_ibfk_2` FOREIGN KEY (`proveedor_id`) REFERENCES `proveedores` (`id`);

--
-- Filtros para la tabla `productos`
--
ALTER TABLE `productos`
  ADD CONSTRAINT `productos_ibfk_1` FOREIGN KEY (`geolocalizacion_id`) REFERENCES `geolocalizacion` (`id`),
